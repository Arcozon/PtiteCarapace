...
#    Updated: 2025/07/11 20:49:25 by gaeudes          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC =  $(SRC_UTILS)  $(SRC_PROMPT)  $(SRC_GNL)  $(SRC_EXEC)  $(SRC_BUILTIN)  $(SRC_PARSING)  $(SRC_EXPAND)
SRC += $(addprefix printf/, $(SRC_PRINTF))
SRC += $(addprefix printf/libft/, $(SRC_LIBFT))
SRC	+= manage_history.c signal_handling.c  main.c

D_SRC = src/

D_INC =  inc/  src/printf/includes/  src/printf/libft/  inc/utils
